...
const RoomDetails = () => {
  ...
  {room?.images.length > 1 && room.images.map((image, index) => (
    <img
      ...
      src={image}
      alt="Room Thumbnail"
      className={`h-full aspect-video rounded-xl shadow-md object-cover cursor-pointer transition-all duration-200 ${mainImage === image ? 'outline-4 outline-orange-500 outline' : ''}`}
    />
  ))}
</div>
    ...
    <div className='flex flex-col items-start gap-4'>
        <div className='flex gap-4'>
            <img src={logo} alt="Host" className='h-14 w-14 md:h-18 md:w-18 rounded-full' />
            <div>
